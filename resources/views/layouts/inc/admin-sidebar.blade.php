                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="sub" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{url('admin/add-subcategory')}}">Add Sub Category</a>
                                    <a class="nav-link {{ Request::is('admin/subcategory') ? 'active':'' }}" href="{{url('admin/subcategory')}}">View Sub Category</a>
                                </nav>
                            </div>
